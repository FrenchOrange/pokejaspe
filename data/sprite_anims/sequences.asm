...
; SPRITE_ANIM_INDEX_DEX_UNOWN_CURSOR
	db SPRITE_ANIM_FRAMESET_DEX_UNOWN_CURSOR, SPRITE_ANIM_SEQ_DEX_CURSOR, $00
; SPRITE_ANIM_INDEX_DEX_SLOWPOKE
	db SPRITE_ANIM_FRAMESET_DEX_SLOWPOKE, SPRITE_ANIM_SEQ_NULL, $00
